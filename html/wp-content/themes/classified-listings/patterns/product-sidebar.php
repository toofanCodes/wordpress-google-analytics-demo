<?php
  ...
  * Slug: classified-listings/product-sidebar
  * Categories: classified-listings-sidebar
  */
?>
...
<h3 class="wp-block-heading has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by price', 'classified-listings' ); ?></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading alignwide has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Categories', 'classified-listings' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="wp-block-heading has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Active filters', 'classified-listings' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="wp-block-heading has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( '', 'classified-listings' ); ?>Filter by stock status</h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="wp-block-heading has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by attribute', 'classified-listings' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="wp-block-heading has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by rating', 'classified-listings' ); ?></h3>
<!-- /wp:heading -->
