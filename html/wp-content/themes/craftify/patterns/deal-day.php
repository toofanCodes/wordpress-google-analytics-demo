...
<!-- wp:query {"queryId":19,"query":{"perPage":"2","pages":0,"offset":0,"postType":"product","order":"asc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"product_cat":[]},"parents":[]},"metadata":{"categories":["posts"],"patternName":"core/query-medium-posts","name":"Image at left"}} -->
...
<!-- wp:wc-booster/countdown {"block_id":"wc-booster-countdown-block-6496ecf8-a170-4ef2-be4a-d7be708ac8f7","boxWidth":{"activeUnit":"px","range":{"min":1,"max":1000},"values":{"desktop":70,"tablet":75,"mobile":75},"units":["px","em"]},"boxHeight":{"activeUnit":"px","range":{"min":1,"max":1000},"values":{"desktop":60,"tablet":70,"mobile":70},"units":["px","em"]},"alignment":"left","targetDate":"2025-06-01T00:00:00"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
