...
<?php if (function_exists('wc_booster_load') && class_exists('WooCommerce')) { ?>
<!-- wp:wc-booster/product-companion {"block_id":"wc-booster-product-companion-block-604761a0-1dfe-4d4a-af2b-e5c16356b212","position":{"activeUnit":"px","range":{"min":0,"max":500},"values":{"desktop":14,"tablet":14,"mobile":14},"units":["%","px","em"]},"positionTop":{"activeUnit":"px","range":{"min":-100,"max":500},"values":{"desktop":14,"tablet":14,"mobile":14},"units":["%","px","em"]},"layoutColumnPadding":{"activeUnit":"px","isLinkActive":true,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[8,8,8,8],"tablet":[8,8,8,8],"mobile":[8,8,8,8]}}} -->
...
<?php if (function_exists('wc_booster_pro_load') && class_exists('WooCommerce')) { ?>
 <!-- wp:wc-booster-pro/product-variation {"block_id":"wc-booster-pro-product-variation-block-c293a79f-08ed-443f-9898-f191b1db76c5","alignment":"left","noOfSwatches":4,"swatchesHoverBgColor":"#000","swatchesHoverTextColor":"#ffffff","height":{"activeUnit":"px","range":{"min":1,"max":2000},"values":{"desktop":30,"tablet":30,"mobile":30},"units":["px","em"]}} /-->
