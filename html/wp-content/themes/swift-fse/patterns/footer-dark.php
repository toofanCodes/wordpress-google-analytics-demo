		...
		<div class="wp-block-column" style="flex-basis:40%">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group">
					...
					<!-- wp:site-title {"level":0,"ploverBlockID":"cdae8e30-486d-49ac-b801-a04c31734449","style":{"typography":{"textTransform":"uppercase","textDecoration":"none"}},"fontSize":"medium"} /-->
				</div>
				<!-- /wp:group -->
