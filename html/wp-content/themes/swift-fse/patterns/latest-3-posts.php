...
<div class="wp-block-group alignfull has-neutral-950-color has-neutral-0-background-color has-text-color has-background has-link-color"
    ...
    <!-- wp:heading {"textAlign":"center","level":2,"ploverBlockID":"3aad0d6f-9ea2-4e10-a9c8-a63025f7e32f","style":{"typography":{"lineHeight":"1"}}} -->
    <h2 class="wp-block-heading has-text-align-center" style="line-height:1">
		<?php esc_html_e( 'Latest Posts', 'swift-fse' ); ?>
    </h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-query alignwide">
        ...
        <p class="has-text-align-center"
           style="padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large)">
			<?php esc_html_e( 'No posts were found.', 'swift-fse' ); ?>
        </p>
        <!-- /wp:paragraph -->
        <!-- /wp:query-no-results -->
