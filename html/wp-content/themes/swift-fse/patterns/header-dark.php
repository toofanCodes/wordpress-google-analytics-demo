...
/**
 * Title: Dark Header
 * Slug: swift-fse/header-dark
 * Categories: header, swift-fse
 * Block Types: core/template-part/header
 */
?>
<!-- wp:group {"metadata":{"name":"Header Dark"},"ploverBlockID":"aa9a536d-7599-480a-8edb-14f3285b7e3b","align":"full","className":"has-sticky-bottom-border is-style-dark","style":{"elements":{"link":{"color":{"text":"var:preset|color|neutral-800"}}}},"backgroundColor":"neutral-0","textColor":"neutral-800","layout":{"type":"constrained"},"stickyBlock":"yes","stickyZIndex":20,"stickyContainer":"document"} -->
<div class="wp-block-group alignfull has-sticky-bottom-border is-style-dark has-neutral-800-color has-neutral-0-background-color has-text-color has-background has-link-color">
